...
RACERS = [
  ...
  ('tena',        '🛵',  'ฮอนด้า เทน่า',    75,      'vehicle',  'Honda Tena'),
  ('horse',       '🐎',  'ม้า',             70,      'farm',     'Horse'),
  ('ostrich',     '🐦',  'นกกระจอกเทศ',     70,      'bird',     'Ostrich'),
  ...
  ('cow',         '🐮',  'วัว',             35,      'farm',     'Cow'),
  ('capybara',    '🦫',  'คาปิบาล่า',       35,      'wild',     'Capybara'),
